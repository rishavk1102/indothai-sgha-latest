...
const Add_handling_companies = ({ onClose, page_name }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await api.post(`/business/add_business/${page_name}`, payload);
      onClose(); // Close sidebar/modal
    } catch (error) {
  ...
  return (
    <>
      <Row className="mx-0 mt-3 addClient">
        <h5 className="text-black">Add Handling Companies</h5>
        <Form className="mt-4">
          <Row className="mx-0">
...
export default Add_handling_companies;
