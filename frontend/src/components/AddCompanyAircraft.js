...
const AddCompanyAircraft = ({ onClose, page_name }) => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const res = await api.post(`/company_aircraft_routes/add_company_aircraft/${page_name}`, formData);
            if (res.status === 201) {
    ...
    return (
        <>
            <Row className="mx-0 mt-3 addClient">
                <h5 className="py-4">Add Company Aircraft</h5>
                ...
                <Col md={12} className="text-end mt-3">
                    ...
                    <Button label="Add Aircraft" className="py-2 border-0" severity="help" onClick={handleSubmit} />
                </Col>
            </Row>
...
export default AddCompanyAircraft